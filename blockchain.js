...
class Blockchain {
  ...
  createGenesisBlock() {
    return new Block(Date.parse("10/15/2020"), [], "0")
  }
  ...
  minePendingTransaction(miningRewardAddress) {
    const rewardTran = new Transaction(null, miningRewardAddress, this.miningReward)
    this.pendingTransactions.push(rewardTran)
